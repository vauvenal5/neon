...
abstract class NeonLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'{app, select, nextcloud{Nextcloud} core{Server} dashboard{Dashboard} files{Files} news{News} notes{Notes} notifications{Notifications} photos{Photos} spreed{Talk} talk{Talk} other{}}'**
